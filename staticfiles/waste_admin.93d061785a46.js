function show(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        content += `
              <br />
              <div class="p-10 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                Number(data[i].fields.weight)
                  ...
                  <p style="color: ${color}" class="text-xl flex-1 p-4 mb-3 font-normal text-700">${message}</p>
                  </div>
                  <div class="item-center justify-center">
                  <button id="waste-update" onClick="{update(${data[i].pk})}" class="p-2 mt-4 bg-white  border border-emerald-400 rounded-lg shadow-md text-emerald-400 hover:bg-emerald-600 hover:text-white duration-300" >verify
                   </button>
